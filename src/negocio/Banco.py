...
class Banco:
    ...
    def procurar_cliente(self, cpf: str) -> Cliente | None:
        return self.clientes.procurar(cpf)

    def cadastrar_conta(self, conta: ContaAbstrata) -> None:
    ...
    def associar_conta(self, cpf: str, numero_conta: str) -> None:
    ...
    def remover_cliente(self, cpf: str) -> None:
            cliente = self.procurar_cliente(cpf)
    ...
    def remover_conta(self, cliente: Cliente, numero_conta: str) -> None:
    ...
    def creditar(self, conta: ContaAbstrata, valor: float) -> None:
        if valor < 0:
            raise ValorInvalidoException()
        conta.creditar(valor)
        self.contas.atualizar(conta)

    def debitar(self, conta: ContaAbstrata, valor: float) -> None:
        if valor < 0:
            raise ValorInvalidoException()
    ...
    def transferir(self, conta_origem: ContaAbstrata, conta_destino: ContaAbstrata, valor: float) -> None:
    ...
    def render_bonus(self, conta: ContaAbstrata) -> None:
    ...
    def render_juros(self, conta: ContaAbstrata) -> None:
